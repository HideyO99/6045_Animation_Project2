...
void createAnimation(cVAOManager* pVAOManager)
{
   ...
   // meshObj->BoneAnimation
    ...
    seq3_bone3.PositionKeyFrames.push_back(PositionKeyFrame(glm::vec3(-25.f, 1.f, -25.f), 0.f, None,boneID_3));
    seq3_bone3.PositionKeyFrames.push_back(PositionKeyFrame(glm::vec3(-12.5f, 25.f, -12.5f), 2.5f, None, boneID_3));
    seq3_bone3.PositionKeyFrames.push_back(PositionKeyFrame(glm::vec3(0.f, 1.f, 0.f), 5.f, None, boneID_3));
    seq3_bone3.ScaleKeyFrames.push_back(ScaleKeyFrame(glm::vec3(10.f), 0.f, None, boneID_3));
    seq3_bone3.ScaleKeyFrames.push_back(ScaleKeyFrame(glm::vec3(5.f), 5.f, None, boneID_3));
    seq3_bone3.RotationKeyFrames.push_back(RotationKeyFrame(glm::quat(1.f, 0.f, 0.f, 0.f), 0.f, None, boneID_3));
    seq3_bone3.RotationKeyFrames.push_back(RotationKeyFrame(glm::quat(0.f, 0.f, 0.f, 1.f), 2.5f, None, boneID_3));
    seq3_bone3.RotationKeyFrames.push_back(RotationKeyFrame(glm::quat(1.f, 0.f, 0.f, 0.f), 5.f, None, boneID_3));
    ...
    seq4_bone4.PositionKeyFrames.push_back(PositionKeyFrame(glm::vec3(-25.f, 1.f, -25.f), 0.f, None, boneID_4));
    seq4_bone4.PositionKeyFrames.push_back(PositionKeyFrame(glm::vec3(-12.5f, 25.f, -12.5f), 2.5f, None, boneID_4));
    seq4_bone4.PositionKeyFrames.push_back(PositionKeyFrame(glm::vec3(0.f, 1.f, 0.f), 5.f, None, boneID_4));
    seq4_bone4.ScaleKeyFrames.push_back(ScaleKeyFrame(glm::vec3(10.f), 0.f, None, boneID_4));
    seq4_bone4.ScaleKeyFrames.push_back(ScaleKeyFrame(glm::vec3(5.f), 5.f, None, boneID_4));
    seq4_bone4.RotationKeyFrames.push_back(RotationKeyFrame(glm::quat(1.f, 0.f, 0.f, 0.f), 0.f, None, boneID_4));
    seq4_bone4.RotationKeyFrames.push_back(RotationKeyFrame(glm::quat(0.f, 0.f, 0.f, 1.f), 2.5f, None, boneID_4));
    seq4_bone4.RotationKeyFrames.push_back(RotationKeyFrame(glm::quat(1.f, 0.f, 0.f, 0.f), 5.f, None, boneID_4));
    ...
    seq5_bone5.PositionKeyFrames.push_back(PositionKeyFrame(glm::vec3(-25.f, 1.f, -25.f), 0.f, None, boneID_5));
    seq5_bone5.PositionKeyFrames.push_back(PositionKeyFrame(glm::vec3(-12.5f, 25.f, -12.5f), 2.5f, None, boneID_5));
    seq5_bone5.PositionKeyFrames.push_back(PositionKeyFrame(glm::vec3(0.f, 1.f, 0.f), 5.f, None, boneID_5));
    seq5_bone5.ScaleKeyFrames.push_back(ScaleKeyFrame(glm::vec3(10.f), 0.f, None, boneID_5));
    seq5_bone5.ScaleKeyFrames.push_back(ScaleKeyFrame(glm::vec3(5.f), 5.f, None, boneID_5));
    seq5_bone5.RotationKeyFrames.push_back(RotationKeyFrame(glm::quat(1.f, 0.f, 0.f, 0.f), 0.f, None, boneID_5));
    seq5_bone5.RotationKeyFrames.push_back(RotationKeyFrame(glm::quat(0.f, 0.f, 0.f, 1.f), 2.5f, None, boneID_5));
    seq5_bone5.RotationKeyFrames.push_back(RotationKeyFrame(glm::quat(1.f, 0.f, 0.f, 0.f), 5.f, None, boneID_5));
